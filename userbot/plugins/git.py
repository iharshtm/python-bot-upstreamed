...
async def source(e):
    ...
    await edit_or_reply(
        e,
        "Click [here](https://github.com/iharshtm/python-bot-upstreamed) to open this bot source code\
        \nClick [here](https://github.com/iharshtm/python-based-bot) to open supported link for railway",
    )
