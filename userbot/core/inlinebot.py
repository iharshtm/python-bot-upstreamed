        ...
        if query.startswith("**Catuserbot"):
            buttons = [
                (
                    ...
                    Button.url("Master", "https://github.com/iharshtm"),
                )
            ]
            ...
            result = builder.article(
                title="Inline Help",
                description="Help menu for Inline commands",
                text=_result[0],
                buttons=_result[1],
                link_preview=False,
            )
